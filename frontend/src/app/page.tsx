  ...
  return (
    <div className="h-screen bg-background flex items-center justify-center p-6 overflow-hidden relative">
      ...
      html, body {
        ...
        .bg-background {
            background-color: #000000 !important; /* Forces a deep premium black */
        }
          `}</style>
      ...
      <div className="w-full max-w-[400px] z-10">
        ...
        <div className="space-y-6">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center space-x-3 p-4 bg-background/50 border border-border/60 rounded-2xl hover:bg-accent/5 hover:border-primary/30 transition-all duration-300 group disabled:opacity-50"
          >
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    onBlur={() => setFocusedField(null)}
                    className="w-full px-4 pr-12 py-3.5 bg-background border border-border/60 rounded-2xl text-sm outline-none transition-all focus:border-white/60 placeholder:text-muted-foreground/40"
                  />
                  <button
                    type="button"
