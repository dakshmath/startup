      ...
      <div className="w-full max-w-[400px] z-10">
        ...
        <div className="space-y-6">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center space-x-3 p-4 bg-background border border-border rounded-2xl hover:bg-primary/5 hover:border-primary/40 transition-all duration-300 group disabled:opacity-50"
          >
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3.5 bg-background border border-border rounded-2xl text-sm outline-none transition-all focus:border-primary focus:ring-1 focus:ring-primary/20 placeholder:text-muted-foreground/40"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  onBlur={() => setFocusedField(null)}
                  className="w-full px-4 pr-12 py-3.5 bg-background border border-border rounded-2xl text-sm outline-none transition-all focus:border-primary focus:ring-1 focus:ring-primary/20 placeholder:text-muted-foreground/40"
                />
                <button
                  type="button"
